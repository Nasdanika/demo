...
@Description("Tests DemoAppRoute")
public class DemoAppRouteTest implements WebTest<WebDriver> {
	...
	@Test
	@Description("Demo App Route")
	@Screenshot({Screenshot.When.AFTER, Screenshot.When.EXCEPTION})
	public void appRoute() throws Exception {
		getWebDriver().get("http://localhost:8080/demo-app/router/demo-app.html?theme="+theme);
